...
CONFIG = {
    ...
    # 专家模型保存路径
    "output_path": "./specialist_drilling_jackhammer",
    
    # 定义专家关注的类别 (Drilling=4, Jackhammer=7)
    "target_class_ids": [4, 7],
    "target_class_names": ["drilling", "jackhammer"],
...
# 建立本地映射: 4->0, 7->1
GLOBAL_TO_LOCAL = {4: 0, 7: 1}
LOCAL_TO_GLOBAL = {0: 4, 1: 7}
